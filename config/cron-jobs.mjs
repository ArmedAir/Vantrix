...
export const CRON_JOBS = [
  ...
  { id: 'character-refund-recovery',  path: '/api/cron/character-refund-recovery', schedule: '*/5 * * * *',  maxDuration: 30, description: 'Retries failed character-creation refunds, every 5min' },
  ...
  { id: 'age-reverification-tick',    path: '/api/cron/age-reverification-tick',  schedule: '0 5 * * *',     maxDuration: 30, description: 'Flips lapsed (12mo) age verifications back to pending for re-check' },
  ...
  { id: 'canon-backfill',             path: '/api/cron/canon-backfill',           schedule: '0 */6 * * *',   maxDuration: 280, description: 'Recovers stuck/missing LoRA canon image sets, every 6h — needs CRON_TIER=pro (see fitsFreeTier).' },
  ...
  { id: 'character-fund-distribution', path: '/api/cron/character-fund-distribution', schedule: '0 6 * * 1', maxDuration: 60, description: 'Weekly Character Value Score computation + Creator Fund payout ledger (Mondays)' },
];
