...
describe('applyEmotionBias', () => {
  ...
  const memories: MemoryNode[] = [
    { id: '1', event_type: 'milestone',  title: 'A', description: '', emotional_weight: 90, tags: [], created_at: now, event_time: now, ingestion_time: now },
    { id: '2', event_type: 'confession', title: 'B', description: '', emotional_weight: 50, tags: [], created_at: now, event_time: now, ingestion_time: now },
    { id: '3', event_type: 'shared_joke',title: 'C', description: '', emotional_weight: 70, tags: [], created_at: now, event_time: now, ingestion_time: now },
  ];
