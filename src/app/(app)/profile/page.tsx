 ...
 * overview; identity editing happens on /profile/edit, app-behavior
 * settings live separately on /profile/settings — see the
 * PROFILE / SETTINGS SPLIT notes on those pages.
 *
...
export default async function ProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 md:px-8 py-8">
      {/* MOTION (2026-09-07): same reasoning as /premium — a fully
          above-the-fold server-rendered page, so a one-time page-load
          reveal rather than a scroll-triggered MotionWrapper. */}
      <CinematicEntrance>
