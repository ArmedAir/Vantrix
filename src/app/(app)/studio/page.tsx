  ...
  return (
    <div className="mx-auto max-w-3xl px-4 md:px-8 py-6">
      <div className="flex items-center justify-between mb-6">
        ...
        {/* EARNINGS-MOVED-TO-ANALYTICS: the Earnings button that used to
            live here now lives at the standalone Analytics page (/analytics)
            as the Creators Dashboard. /studio/earnings itself now just
            redirects there. */}
