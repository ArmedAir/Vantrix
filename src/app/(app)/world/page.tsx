    ...
    <div className="mx-auto max-w-7xl px-4 md:px-8 py-6">
      ...
      <Tabs defaultValue="overview" className="mt-6">
        ...
        <TabsContent value="overview" className="pt-6 space-y-8">
          {/* MOTION (2026-09-07): World's tabs previously rendered inert on
              first paint like Home's discovery rows did before the
              LUXURY-SCROLL fix — same MotionWrapper, same reasoning. Only
              the overview tab's sections get the scroll-reveal treatment
              since it's the tab visible on first load; the other tabs
              mount on-demand when a visitor clicks them, so a scroll
              reveal there would fire while the tab is already fully in
              view and just look like a delay, not a reveal. */}
          <MotionWrapper>
            <section>
              <DailyChoiceCard />
            </section>
