...
import { ModerationHoldsPanel } from "@/components/admin/safety/moderation-holds-panel";
...
import { CreatorFundFlagsPanel } from "@/components/admin/safety/creator-fund-flags-panel";
...
const TABS = [
  ...
  { value: "moderation-settings", label: "Moderation Settings" },
  { value: "revocation", label: "Revocations" },
  { value: "suspensions", label: "Suspensions" },
  { value: "creator-fund", label: "Creator Fund" },
];
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-16">
      ...
      <div>
        ...
        {tab === "holds" && <ModerationHoldsPanel />}
        {tab === "moderation-settings" && <ModerationSettingsPanel />}
        {tab === "revocation" && <RevocationFlagsPanel />}
        {tab === "suspensions" && <SuspensionLookup />}
        {tab === "creator-fund" && <CreatorFundFlagsPanel />}
      </div>
    </div>
  );
}
