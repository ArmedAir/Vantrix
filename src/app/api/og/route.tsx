...
export async function GET(req: NextRequest) {
 ...
 background: "rgba(255,63,159,0.3)",
 filter: "blur(80px)", display: "flex",
 }} />
 ...
 {/* Brand — LOGO FIX: this row was plain "VANTRIX" text in an
 unrelated orange (#FF6B35 matches nothing else on this card,
 which is pink/rose throughout) with no mark at all; now renders
 the real pink-to-purple V (public/images/vantrix-mark-v2.png). */}
 <div style={{
 display: "flex",
 alignItems: "center",
 gap: "10px",
 ...
 <img
 src={new URL("/images/vantrix-mark-v2-small.png", req.url).toString()}
 alt="Vantrix"
 width={22}
 height={16}
