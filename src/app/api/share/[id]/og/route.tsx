...
export async function GET(
 ...
 >
 {/* Brand mark — LOGO FIX: this was a plain grey "VANTRIX" text
 label; every other share/OG surface in the app now renders the
 real pink-to-purple V mark (public/images/vantrix-mark-v2.png),
 so this card was the one left showing the old placeholder-style
 wordmark instead of the actual brand. */}
 <div
 style={{
 display: 'flex',
 alignItems: 'center',
 ...
 <img
 src={absoluteUrl('/images/vantrix-mark-v2-small.png')}
 alt="Vantrix"
 width={28}
 height={20}
