...
export const metadata = generateSEOMeta({
  ...
  description:
    "Open roles at Vantrix, an AI companion platform based in New York, USA.",
  path: "/careers",
});
    ...
    <div className="min-h-screen bg-base">
      ...
      <main className="max-w-2xl mx-auto px-4 md:px-8 py-16">
        ...
        <p className="mt-6 text-[15px] leading-relaxed text-text-secondary">
          We&apos;re based in New York, USA. We don&apos;t have open roles
          listed here yet. If you&apos;re interested in working on AI
          companion systems — relationship modeling, memory, safety, or
          product — reach out directly at{" "}
          <a
