  ...
  return (
    <div className="min-h-screen bg-base flex items-center justify-center px-6">
      <div className="w-full max-w-[400px]">
        {/* LOGO FIX: this was the last hand-rolled placeholder — a flat
            bg-gold-fill tile with a hardcoded "V" and a plain-text
            wordmark — that shell/logo.tsx's own docstring already
            describes fixing on PublicHeader/Sidebar/MobileDrawer/landing.
            <Logo withWordmark> renders the real, theme-reactive mark +
            shimmer wordmark instead, so this auth page stops drifting
            from the rest of the brand surface. */}
        <div className="flex items-center justify-center mb-10">
          <Logo size={36} withWordmark wordmarkClassName="text-2xl" />
        </div>
