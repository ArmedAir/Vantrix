...
export const viewport: Viewport = {
  // Gold default. All themes now share this same flat black meta color
  // (no per-theme tint — see globals.css's COLOR-LEAK FIX), so
  // public/theme-init.js and theme-store.ts still re-apply it on
  // load/toggle for consistency, but it's a no-op repaint rather than a
  // visible correction. This static value can't itself read the theme
