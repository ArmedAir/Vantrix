  ...
  return (
    <>
      <button
        ...
        className="relative h-10 w-10 shrink-0 rounded-full overflow-hidden ring-2 ring-gold-500/40 shadow-[0_0_0_1px_rgba(0,0,0,0.4),0_2px_10px_-2px_rgba(201,161,90,0.35)] transition-shadow ease-premium hover:ring-gold-500/60"
      >
        <Image
          src={imageSrc}
          alt={characterName}
