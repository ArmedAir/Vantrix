...
export function DatePicker({
  ...
  if (completedMsg) {
    return (
      <p className="flex items-center gap-2 rounded-sm border border-gold-500/30 bg-gradient-to-r from-gold-500/10 to-transparent px-3 py-2 text-sm text-gold-400">
  ...
  if (live) {
    return (
      <div className="rounded-md border border-gold-500/30 bg-gradient-to-br from-gold-500/10 via-gold-500/[0.03] to-transparent p-4">
        ...
        {DATE_CATALOGUE.map((date) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-2xl drop-shadow-[0_1px_2px_rgba(0,0,0,0.4)]">{date.emoji}</span>
