...
import { getDiscordUrl } from "@/lib/config/contact";
...
export async function Footer() {
  // CONTACT-EMAIL removed from the footer on request (2026-09-14) — see
  // FooterColumn's own removed mailto: link. getContactEmail() itself is
  // untouched (still backs other surfaces); this file just no longer
  // calls it.
