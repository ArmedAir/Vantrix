      ...
      <div className="p-2 border-t border-border-hairline shrink-0 space-y-1">
        ...
        {!railCollapsed && (
          <div className="pt-1 mt-1 border-t border-border-hairline space-y-1 animate-fade-in">
            {/* DISCORD-FOLD: the standalone Discord icon is gone — /support
                (Help Center, right below) already lists the Discord invite
                alongside the contact email in its own copy, so this row no
                longer needs two entries for effectively one destination.
                discordUrl dropped from this component's props entirely
                (no remaining consumer) — see (app)/layout.tsx's own trim. */}
            <div className="grid grid-cols-3 gap-1">
              ...
              <Tooltip content="Help Center & Discord" side="top">
                <Link
                  href="/support"
                  className="h-9 flex items-center justify-center rounded-xs text-text-tertiary hover:text-text-primary hover:bg-white/[0.04] transition-colors ease-premium"
                >
