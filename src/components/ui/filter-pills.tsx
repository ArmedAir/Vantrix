      ...
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={cn(
              "shrink-0 inline-flex items-center gap-1.5 rounded-full border px-4 py-2 text-sm font-medium transition-all duration-150 ease-premium active:scale-95",
              active
                ? "bg-gold-500 border-gold-500 text-[#160F02] shadow-gold-glow"
