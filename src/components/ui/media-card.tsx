 ...
 *
 * NO-BLUR FIX (2026-09-14): the bottom text panel previously
 * backdrop-blurred the photo behind it (a "frosted glass shelf" for the
 * name/tags). Across a grid of these cards that read as a visible haze
 * over roughly the bottom two-thirds of every character photo — the
 * face/detail people actually browse cards to see was the part getting
 * obscured. Reverted to a plain gradient scrim: still enough darkening
 * for the text to stay legible over a bright photo, but the photo
 * itself stays sharp edge-to-edge, matching the pre-glass card look.
 */
 ...
 * the New/Hot badge rather than replace it. */
 ...
 return (
 <Card className={cn("p-0 group", className)}>
 ...
 priority={priority}
 className="object-cover object-top transition-transform duration-500 ease-premium group-hover/card:scale-[1.05]"
 />
 ...
 aria-hidden
 />
 {/* Bottom scrim — plain gradient only (no backdrop-blur, see
 NO-BLUR FIX above), just enough darkening for the name/tags to
 stay legible over a bright photo. Bounded to the bottom ~2/3
 rather than the full card so the top (badges, most of the
 portrait) stays perfectly sharp. */}
 <div
