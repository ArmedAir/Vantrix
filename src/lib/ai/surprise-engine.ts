...
//
// nudge.ts's message pool used to fail this exact guard ("Your bond with
// {name} is fading. Time to show you care") — that's fixed now (see that
// file's header); this note stays only so the history doesn't look
// mysterious to whoever finds the old flag in a past delivery's notes.
