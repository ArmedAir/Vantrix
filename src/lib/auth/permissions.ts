...
export type AdminPermission =
  ...
  | 'social.publish' // approve/reject/publish-now on the X cross-posting queue (/admin/social)
  | 'moderation.settings_manage' // edit moderation_prompt_config + keyword_watchlist hold_for_review holds queue
  | 'creator_fund.review' // review the Creator Fund self-dealing/farming flag queue (/admin/safety, Creator Fund tab)
  | 'platform.settings_manage'; // edit platform_settings (maintenance mode, signups, global NSFW gate) — /admin/settings
...
export const PERMISSION_LABELS: Record<AdminPermission, string> = {
  ...
  'social.publish': 'Approve, reject, or publish-now on the X cross-posting queue',
  'moderation.settings_manage': 'Edit AI-moderation prompt tuning and manage the hold-for-review queue',
  'creator_fund.review': 'Review the Creator Fund self-dealing/farming flag queue',
  'platform.settings_manage': 'Edit platform-wide settings (maintenance mode, signups, global NSFW gate)',
};
