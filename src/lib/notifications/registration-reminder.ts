...
<html>
 ...
 <a href="${ctaUrl}" style="display:block;text-align:center;background:#6B6B74;color:#ffffff;text-decoration:none;font-weight:600;font-size:15px;padding:14px 24px;border-radius:10px;">${content.ctaLabel}</a>
 </td>
 </tr>
 <tr>
