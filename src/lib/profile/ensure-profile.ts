 ...
 *
 * GENDER-WIRE-FIX (2026-09-09): login-form.tsx's signup form now collects
 * gender and sets pending_gender alongside pending_dob in signUp()'s
 * options.data, so this read is live — no longer the dead capacity the
 * 2026-08-20 audit noted. OAuth users still won't have this set (no
 * signUp() call in that flow) — they're prompted in /profile settings on
 * first visit instead, per the original design this function describes.
 */
