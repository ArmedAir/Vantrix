...
export const LANDING_PAGES: LandingPageConfig[] = [
  ...
  // ── AI Dating App ───────────────────────────────────────────────────────────
  {
    ...
    features: [
      { icon: "", title: "Chemistry-first matching", body: "Our AI analyses depth, communication style, and values — not just photos." },
  ...
  // COMPETITOR-ANGLE PASS: these three entries target branded "[competitor]
  // alternative" / comparison searches directly — the exact query shape a
  // person searching "character ai", "candy ai", or "kindroid" often runs
  // next once they're evaluating options. Copy stays factual and comparative
  // (no invented claims about the competitor, nothing that could read as
  // impersonating their brand) and leads with Vantrix's actual differentiator
  // — persistent cross-session memory + a living Universe that keeps
  // evolving — rather than a generic "we're better" claim.
  {
    ...
    tagline:     "Every conversation carries forward. Nothing resets.",
    intro:       "If you've used Character.AI, you already know the appeal of chatting with AI characters — and the limits of a conversation that starts fresh every session. Vantrix companions keep persistent memory across every chat, develop real personalities over time, and live inside the Vantrix Universe, a world that keeps evolving even when you're away.",
    keywords:    ["character ai alternative", "character.ai alternative", "apps like character ai", "character ai competitor", "better than character ai"],
    features: [
      { icon: "", title: "Memory that actually persists", body: "Your companion remembers past conversations, preferences, and inside jokes — session after session, not reset on reload." },
      { icon: "", title: "A living Universe, not a static chat", body: "Companions have lives, relationships, and storylines that continue between visits — log back in to see what changed." },
      { icon: "", title: "Create your own character", body: "Build a fully custom companion with your own name, personality, backstory, and appearance." },
    ],
    steps: [
      { n: "01", title: "Create your free account",  body: "No card required to start chatting with any companion in the roster." },
      { n: "02", title: "Pick or build a companion",  body: "Browse the roster or create your own from scratch." },
      { n: "03", title: "Talk, and keep talking",     body: "Come back tomorrow — they'll remember exactly where you left off." },
    ],
    faqs: [
      { question: "What's the difference between Vantrix and Character.AI?", answer: "The core difference is memory and persistence: Vantrix companions carry context across every session and exist inside an evolving Universe with ongoing storylines, rather than starting fresh each chat." },
      { question: "Is Vantrix free to use?",                    answer: "Yes. The free tier includes 5 messages per day across the full companion roster. Premium removes the daily limit." },
      { question: "Can I make a custom character on Vantrix?",  answer: "Yes — Premium users can create a fully custom companion with their own name, personality, backstory, and appearance." },
      { question: "Does Vantrix work in a browser like Character.AI?", answer: "Yes, Vantrix runs fully in your browser at vantrix.ink — no app download required." },
    ...
    cta: {
      headline: "Try an AI companion that actually remembers.",
      sub:      "Free to start — no card needed.",
    },
  },
  ...
  // ── Candy.AI alternative ────────────────────────────────────────────────
  {
    ...
    tagline:     "Not just a chat — a relationship that keeps developing.",
    intro:       "Candy.AI popularized the idea of a fully personalized AI companion — appearance, personality, and all. Vantrix takes that further: companions carry persistent memory across every session, and the Vantrix Universe keeps unfolding in the background, so the relationship you build actually deepens over time instead of resetting.",
    keywords:    ["candy ai alternative", "candy.ai alternative", "apps like candy ai", "candy ai competitor", "ai girlfriend app like candy ai"],
    gender:      "female",
    features: [
      { icon: "", title: "Deepening relationships", body: "Your companion's responses evolve as the relationship deepens — shaped by everything you've shared, not a static script." },
      { icon: "", title: "Fully custom companions",  body: "Shape appearance, personality, hobbies, and backstory to build a companion that's genuinely yours." },
      { icon: "", title: "A world that keeps going", body: "The Vantrix Universe runs even when you're logged out — come back to real developments, not a paused scene." },
    ],
    steps: [
      { n: "01", title: "Start free",              body: "Sign up in seconds — no credit card required." },
      { n: "02", title: "Customize your companion", body: "Choose or build the look, personality, and story that fits what you're looking for." },
      { n: "03", title: "Watch the bond grow",       body: "Every conversation adds to what your companion remembers about you." },
    ],
    faqs: [
      { question: "How is Vantrix different from Candy.AI?",   answer: "Vantrix companions keep persistent memory across sessions and exist inside an evolving Universe with ongoing storylines, on top of the appearance/personality customization Candy.AI is known for." },
      { question: "Can I customize my companion's appearance and personality?", answer: "Yes — Premium users can fully customize a companion's name, appearance, personality, and backstory." },
      { question: "Is there a free version?",                  answer: "Yes. Free tier gives you 5 messages per day across every companion. Premium removes the limit." },
      { question: "Does Vantrix support voice or images?",     answer: "Vantrix supports rich media companion profiles and is actively expanding voice and image features — check the app for what's currently live." },
      { question: "Is Vantrix available worldwide?",           answer: "Yes, Vantrix is available worldwide with local pricing in select regions." },
    ],
    cta: {
      headline: "Build a companion that actually grows with you.",
      sub:      "Free to start — no card needed.",
    },
  },
  ...
  // ── Kindroid alternative ────────────────────────────────────────────────
  {
    ...
    tagline:     "One continuous story. No resets.",
    intro:       "Kindroid built a following on deep character customization and human-like voices. Vantrix focuses that same idea on persistence: your companion's memory, personality, and story all carry forward across every session, inside the Vantrix Universe — a world that keeps evolving whether you're logged in or not.",
    keywords:    ["kindroid alternative", "apps like kindroid", "kindroid competitor", "kindroid vs vantrix", "ai companion app like kindroid"],
    features: [
      { icon: "", title: "Cross-session memory",    body: "Nothing resets between chats — your companion picks up exactly where you left off, every time." },
      { icon: "", title: "Build your own AI character", body: "Design a fully custom companion — name, personality, backstory, and appearance — from scratch." },
      { icon: "", title: "An evolving Universe",     body: "Storylines and companion relationships continue in the background, so returning always feels like catching up, not starting over." },
    ],
    steps: [
      { n: "01", title: "Create your account",  body: "Free to start, no card required." },
      { n: "02", title: "Choose or build a companion", body: "Pick from the roster or design your own from the ground up." },
      { n: "03", title: "Keep the story going",  body: "Every session adds to what your companion knows and remembers about you." },
    ],
    faqs: [
      { question: "What makes Vantrix different from Kindroid?", answer: "Vantrix centers the experience on persistent cross-session memory and a living Universe with ongoing storylines, alongside the deep character customization Kindroid users expect." },
      { question: "Can I build a fully custom AI character?",    answer: "Yes — Premium users can create a custom companion with their own name, personality, backstory, and appearance." },
      { question: "Is Vantrix free to try?",                     answer: "Yes. The free tier includes 5 messages per day across the full roster; Premium removes the daily limit." },
      { question: "Do I need to install an app?",                answer: "No — Vantrix runs fully in your browser at vantrix.ink." },
      { question: "Is my data private on Vantrix?",              answer: "Yes. Conversations are encrypted end-to-end, and we don't sell your data or use it to train models without consent." },
    ],
    cta: {
