...
//
//   Paystack recurring (plan-based) quarterly/annual subscriptions are
...
export function getUpgradePrompt(_userTier: TierId, reason: UpgradeReason): {
  ...
  const prompts: Record<string, { headline: string; subhead: string; cta: string; targetTier: TierId }> = {
    messages: {
      headline: 'A conversation worth continuing.',
      subhead: 'Premium membership means the thread never has to pause.',
      cta: 'Continue as a Premium member',
      targetTier: 'premium',
    },
    images:  {
      headline: 'See them exactly as you imagine.',
      subhead: 'Premium membership opens every mood room and every scene, without a daily ceiling.',
      cta: 'Unlock scene generation',
      targetTier: 'premium',
    },
    videos: {
      headline: 'Bring the moment to life.',
      subhead: 'Video generation is reserved for Premium members.',
    ...
    nsfw: {
      ...
      subhead: 'Premium membership removes the ceiling entirely.',
      cta: 'Become a Premium member',
      targetTier: 'premium',
    },
    twin: {
      headline: 'Your Digital Twin awaits.',
      subhead: 'Trained on how you actually talk — reserved for Premium members.',
      cta: 'Become a Premium member',
      targetTier: 'premium',
    },
    character: {
      headline: 'This companion is a Premium exclusive.',
      subhead: 'Every character is open to browse — this one\u2019s conversations are reserved for Premium members.',
      cta: 'Unlock this companion',
      targetTier: 'premium',
    },
    swipes: {
      headline: 'The deck deserves to stay open.',
      subhead: 'Premium membership removes the daily limit on matches entirely.',
      cta: 'Unlock unlimited swipes',
      targetTier: 'premium',
    },
    tokens: {
      headline: 'A little more is called for.',
      subhead: 'Premium membership includes a generous monthly allowance, so you\u2019re never interrupted mid-conversation.',
      cta: 'Explore Premium',
      targetTier: 'premium',
    },
  };
