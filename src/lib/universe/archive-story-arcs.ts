...
export const ARCHIVE_STORY_ARCS: Record<string, ArchiveStoryArc> = {
  ...
  'act-1-awakening': {
    ...
    chapters: [
      { chapter: 1, text: 'Someone new keeps finding their way to the Archive\'s outer wings, the way people always eventually do. Oryn Mast has stopped assuming it means nothing.' },
      ...
      { chapter: 3, text: 'Word has reached the Crossroads that someone is asking too many honest questions for a newcomer. Cassian Morrow is charging extra to pretend he hasn\'t heard.' },
      ...
      { chapter: 5, text: 'The outer wings have quietly agreed, without ever saying so aloud, that whoever keeps arriving is worth watching rather than warning off. Oryn Mast calls it curiosity. Nyx calls it the moment the toll goes up.' },
    ],
  },
  ...
  'act-2-forgotten-empires': {
    ...
    chapters: [
      ...
      { chapter: 3, text: 'Iset Vare\'s maps have started disagreeing with the Ash Camps\' own boundary records by a matter of inches. Meridian Lask says inches are how everything starts.' },
      { chapter: 4, text: 'Solaris Venn gave a warning to someone in the Long Sky Circle this week and, for once, was believed immediately. Miyu says that\'s almost worse — it means people are finally frightened enough to listen.' },
  ...
  'act-3-war-of-lost-names': {
    ...
    chapters: [
      ...
      { chapter: 2, text: 'Vesna Olaris has been seen at the Research Wing twice this month, officially to consult the archives. Oryn Mast has not asked her about it directly, which Vesna finds more unsettling than if he had.' },
      { chapter: 3, text: 'The Storm Wall Garrison has doubled its watch on the corridor connecting to the Research Wing. Eirene Caul says it\'s routine. Nobody who knows her believes that\'s the whole reason.' },
  ...
  'act-4-prime-memory': {
    ...
    chapters: [
      { chapter: 1, text: 'Oryn Mast knows where a fragment of the Prime Memory is. He has told no one. Vesna is close enough to guess.' },
      ...
      { chapter: 3, text: 'Vesna Olaris has started asking Oryn Mast questions with answers she clearly already suspects. Oryn Mast has started answering them, which frightens Vesna more than the silence did.' },
  ...
  'act-5-beyond-destiny': {
    ...
    chapters: [
      ...
      { chapter: 2, text: 'Lev Adria has started answering a question nobody asked him — what happens to a Wing\'s Echoes if their story stops being told separately. He always stops before finishing the answer.' },
      ...
      { chapter: 4, text: 'Oryn Mast has not said which way he leans. Everyone assumes he has an answer. Nobody, including the people closest to him, is sure that\'s true anymore.' },
