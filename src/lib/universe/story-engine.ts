...
const STORY_SEEDS = [
  ...
  },
  {
    ...
    description: 'Something in the Wing of the Crack has started showing a reflection that wasn\'t there last season. Natalie has been asked not to describe it publicly.',
  },
];
